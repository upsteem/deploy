...
describe Upsteem::Deploy::Factories::TestRunners::SkipperFactory do
  ...
  let(:service_class) { Upsteem::Deploy::Services::TestRunners::Skipper }
  let(:service) { instance_double("Upsteem::Deploy::Services::TestRunners::Skipper") }
