...
describe Upsteem::Deploy::Factories::TestRunners::RspecFactory do
  ...
  let(:service_class) { Upsteem::Deploy::Services::TestRunners::Rspec }
  let(:service) { instance_double("Upsteem::Deploy::Services::TestRunners::Rspec") }
